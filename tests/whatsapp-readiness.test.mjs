...
test("manual WhatsApp demo requires an authenticated company session and explicit template", () => {
...
test("both runtimes support optional WABA id for template verification", () => {
