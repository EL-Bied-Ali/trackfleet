...
function deliveryStatement(db: D1Binding, delivery: DeliveryRow) {
  ...
  ON CONFLICT(id) DO UPDATE SET
    ...
    contact = excluded.contact, recipient_name = excluded.recipient_name, recipient_contact = excluded.recipient_contact, weight_kg = excluded.weight_kg, price_amount = excluded.price_amount, price_currency = excluded.price_currency, item_description = excluded.item_description,
