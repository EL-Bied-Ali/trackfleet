    ...
    <div className="deliveries-panel">
      ...
      <div className="table-wrap">
        {visibleDeliveries.length === 0 ? <div className="deliveries-empty">
          ...
          <thead><tr><th>{t.tableDelivery}</th><th>{locale === "fr" ? "Contrôle colis" : locale === "nl" ? "Pakketcontrole" : "Parcel control"}</th><th>{t.tableCustomer}</th>{company?.role === "dispatcher" && <th>{locale === "fr" ? "Agence" : locale === "nl" ? "Agentschap" : "Agency"}</th>}<th>{t.tableJourney}</th><th className="col-actions">{t.tableActions}</th></tr></thead>
