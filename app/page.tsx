...
export default function Home() {
  ...
  const creationEstimatedArrival = creationDepartureDate && !Number.isNaN(creationDepartureDate.getTime())
    ? estimateRelayArrival(creationDestinationSiteId, creationDepartureDate)
    : null;
