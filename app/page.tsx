...
export default function Home() {
  ...
  async function createDelivery(event: React.FormEvent<HTMLFormElement>) {
    ...
    const draftDelivery = {
      ...
      priceCurrency: priceRaw ? String(form.get("priceCurrency") ?? "EUR") : null,
      whatsappOptIn,
    };
    setCreating(true);
    try {
